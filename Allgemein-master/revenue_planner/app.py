...
pages = st.navigation({
    ...
    "Input & Stammdaten": [
        ...
        st.Page(str(BASE / "ui/pages/7_Oeffnungstage.py"),
                title="Filial-Öffnungstage",    icon=":material/calendar_month:"),
        st.Page(str(BASE / "ui/pages/6_Feiertage_Import.py"),
                title="Feiertage u. Ferien",    icon=":material/event:"),
        st.Page(str(BASE / "ui/pages/10_Datumsmapping.py"),
    ...
    "Berechnung & Validierung": [
        ...
        st.Page(str(BASE / "ui/pages/14_Planungsgenauigkeit2.py"),
